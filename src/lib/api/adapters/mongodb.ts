// ===============================================
// ADAPTADOR PARA BACKEND MONGODB
// ===============================================
...
/**
 * Configuración del adaptador MongoDB
 */
const MONGODB_CONFIG: BackendAdapter = {
  type: 'mongodb',
  baseURL: process.env.NEXT_PUBLIC_MONGODB_URL || 'http://localhost:3001',
  version: 'v1',
  endpoints: getEndpoints('mongodb'),
  headers: {
...
// Cliente HTTP específico para MongoDB
const client = createHttpClient({
  baseURL: MONGODB_CONFIG.baseURL,
  timeout: MONGODB_CONFIG.timeout,
});
...
// ===============================================
// SERVICIOS DE USUARIOS (ESPECÍFICO MONGODB)
// ===============================================
...
export const usuarioService = {
   ...
   */
  async getAll(params?: QueryParams): Promise<ApiResponse<Usuario[]>> {
    const url = buildFullUrl('/api/usuarios', undefined, params);
  ...
  async getById(id: string): Promise<ApiResponse<Usuario>> {
    return await client.get(`/api/usuarios/${id}`);
  },
  ...
  async create(data: Partial<Usuario>): Promise<ApiResponse<Usuario>> {
    return await client.post('/api/usuarios', data);
  },
  ...
  async update(id: string, data: Partial<Usuario>): Promise<ApiResponse<Usuario>> {
    return await client.put(`/api/usuarios/${id}`, data);
  },
  ...
  async delete(id: string): Promise<ApiResponse> {
    return await client.delete(`/api/usuarios/${id}`);
  },

  /**
   * Buscar usuarios
   */
  async search(query: string, filters?: FilterParams): Promise<ApiResponse<Usuario[]>> {
    const params = { q: query, ...filters };
    const url = buildFullUrl('/api/usuarios/search', undefined, params);
    return await client.get(url);
  },
  ...
  async getStats(): Promise<ApiResponse<any>> {
    return await client.get('/api/usuarios/stats');
  },
  ...
  async getByRole(role: string): Promise<ApiResponse<Usuario[]>> {
    return await client.get(`/api/usuarios/role/${role}`);
  },

  /**
   * Obtener usuarios por parroquia
   */
  async getByParroquia(parroquiaId: string): Promise<ApiResponse<Usuario[]>> {
    return await client.get(`/api/usuarios/parroquia/${parroquiaId}`);
  },

  /**
   * Cambiar contraseña
   */
  async changePassword(id: string, passwordData: any): Promise<ApiResponse> {
    return await client.put(`/api/usuarios/${id}/change-password`, passwordData);
  },
  ...
  async resetPassword(id: string): Promise<ApiResponse> {
    return await client.post(`/api/usuarios/${id}/reset-password`);
  },
};
...
export const catequizandoService = {
  ...
  /**
   * Obtener sacramentos de catequizando
   */
  async getSacramentos(id: string): Promise<ApiResponse<any[]>> {
    return await client.get(`/api/catequizandos/${id}/sacramentos`);
  },

  /**
   * Obtener representantes de catequizando
   */
  async getRepresentantes(id: string): Promise<ApiResponse<any[]>> {
    return await client.get(`/api/catequizandos/${id}/representantes`);
  },

  /**
   * Obtener padrinos de catequizando
   */
  async getPadrinos(id: string): Promise<ApiResponse<any[]>> {
    return await client.get(`/api/catequizandos/${id}/padrinos`);
  },

  /**
   * Obtener datos de bautismo
   */
  async getBautismo(id: string): Promise<ApiResponse<any>> {
    return await client.get(`/api/catequizandos/${id}/bautismo`);
  },
...
export const grupoService = {
   ...
   */
  async getCatequistas(id: string): Promise<ApiResponse<Usuario[]>> {
...
export const asistenciaService = {
   ...
   */
  async addObservacion(id: string, observacion: any): Promise<ApiResponse<Asistencia>> {
    return await client.post(`/api/asistencias/${id}/observaciones`, observacion);
  },
...
// ===============================================
// SERVICIOS DE LOGS (ESPECÍFICO MONGODB)
// ===============================================
...
export const logService = {
   ...
   */
  async getActivityLogs(params?: QueryParams): Promise<ApiResponse<any[]>> {
    const url = buildFullUrl('/api/logs/activity', undefined, params);
    return await client.get(url);
  },
   ...
   */
  async getSystemLogs(params?: QueryParams): Promise<ApiResponse<any[]>> {
    const url = buildFullUrl('/api/logs/system', undefined, params);
    return await client.get(url);
  },
};
